...
init_state = State(locks=[
    ...
    Switch(6, 'Свет Театр весь', 5, 6),  # добавить i2c
    Switch(7, 'Свет Театр бра', 5, 6),  # добавить i2c
    Switch(8, 'Свет Коридор  ', 5, 6),  # добавить i2c
    Switch(9, 'Свет Тёмная комната  ', 5, 6),  # добавить i2c
    Switch(10, 'Свет Кладбище  ', 5, 6),  # добавить i2c
    Switch(11, ' Финал ', 5, 6),  # добавить i2c
    Switch(12, 'Рестарт', 58, 6),  # добавлен
    Switch(13, ' дверь 1 -Красная комната', 5, 6),  # добавить i2c
    Switch(14, ' дверь 2 -Театр  ', 5, 6),  # добавить i2c
