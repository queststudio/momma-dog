...
init_state = State(locks=[
    ...
    Switch(6, 'Свет Театр весь', 61, 6),  # добавить i2c
    Switch(7, 'Свет Театр бра', 61, 5),  # добавить i2c
    Switch(8, 'Свет Коридор  ', 61, 4),  # добавить i2c
    Switch(9, 'Свет Тёмная комната  ', 61, 3),  # добавить i2c
