...
init_state = State(locks=[
    ...
    Lock('Обжорство - фрукты', 57, 0, [
        Puzzle('62:01:94:70:60:70', 22,23) #вставить мак ОБЖОРСТВО
    ]),
    Lock('Сцена КОД', 57, 7, [
    ...
    Lock('Крест', 58, 6, [
        Puzzle('62:01:94:70:60:70', 20) #вставить MAC
    ]),
    Lock('сундук 1', 58, 1, [
        Puzzle('62:01:94:70:60:70', 15) #вставить MAC
    ]),
    Lock('сундук 2', 58, 2, [
        Puzzle('62:01:94:70:60:70', 16) #вставить MAC
    ]),
    Lock('сундук 3', 58, 3, [
        Puzzle('62:01:94:70:60:70', 17) #вставить MAC
    ]),
    Lock('сундук 4', 58, 4, [
        Puzzle('62:01:94:70:60:70', 18) #вставить MAC
    ])
